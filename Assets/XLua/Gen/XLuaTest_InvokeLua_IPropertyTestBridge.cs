...
{
    public class XLuaTestInvokeLuaIPropertyTestBridge : LuaBase, XLuaTest.InvokeLua.IPropertyTest
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new XLuaTestInvokeLuaIPropertyTestBridge(reference, luaenv);
		}
		
		public XLuaTestInvokeLuaIPropertyTestBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
        ...
        int[] XLuaTest.InvokeLua.IPropertyTest.Test 
        {
        ...
        object XLuaTest.InvokeLua.IPropertyTest.this[int index]
		{
		    get
			{
#if THREAD_SAFE || HOTFIX_ENABLE
