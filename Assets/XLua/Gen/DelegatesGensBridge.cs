...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public Tutorial.CSCallLua.DClass __Gen_Delegate_Imp12(int p0, string p1, out int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                Tutorial.CSCallLua.DClass __gen_ret = (Tutorial.CSCallLua.DClass)translator.GetObject(L, errFunc + 1, typeof(Tutorial.CSCallLua.DClass));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Tutorial.CSCallLua.TestDelegate))
			{
			    return new Tutorial.CSCallLua.TestDelegate(__Gen_Delegate_Imp12);
			}
